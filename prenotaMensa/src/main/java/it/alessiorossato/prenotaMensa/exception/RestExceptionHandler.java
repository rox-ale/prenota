...
public class RestExceptionHandler  extends ResponseEntityExceptionHandler
{
	...
	LogUtente log=new LogUtente(RestExceptionHandler.class);
	...
	public ResponseEntity<ErrorResponse> exceptionUserNotfoundHandler(Exception ex)
	{
		ErrorResponse errore = new ErrorResponse();
	...
	public ResponseEntity<ErrorResponse> exceptioHandler(Exception ex)
	{
		System.out.println("Eccezione generica");
		ErrorResponse errore = new ErrorResponse();

		errore.setCodice(HttpStatus.GONE.value());
		errore.setMessaggio(ex.getMessage());
		log.error(errore.toString());
		return new ResponseEntity<ErrorResponse>(errore, HttpStatus.GONE);
	}

	@ExceptionHandler(EccezioneGenericaException.class)
	public ResponseEntity<ErrorResponse> eccezioneGenericaExceptionHandler(Exception ex)
	{
		ErrorResponse errore = new ErrorResponse();
